...
public class SideBarController implements Initializable {
    ...
    void goToEvents(ActionEvent event) {
        ...
        switch (user.getRole()) {
            case ROLE_ADMIN:
                fxmlPath = "/event/AfficherEvents.fxml";  // Admin
                break;
            case ROLE_STUDENT:
                fxmlPath = "/event/UserInterface.fxml";   // Student
                break;
            default:
                showAlert("Unknown or unsupported role.");
                return;
        }
        ...
        try {
            ...
            e.printStackTrace();
            showAlert("Error loading the interface: " + e.getMessage());
        }
    }
